...
class OccupancyGridMap:
    ...
    def get_index_from_coordinates(self, x, y):
        ...
        x_index = int(round((x+self.dim_meters[1]/2)/self.cell_size))
        y_index = int(round((y+self.dim_meters[0]/2)/self.cell_size))
    ...
    def get_coordinates_from_index(self, x_index, y_index):
        ...
        x = x_index*self.cell_size-self.dim_meters[1]/2
        y = y_index*self.cell_size-self.dim_meters[0]/2
